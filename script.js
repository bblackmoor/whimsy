...
window.onload = function() {
	...
	data[i++] = [
			...
			"Unusual conditions change the normal course of events for good or ill. The circumstances can be personal, such as a character's mood, or impersonal, such as the weather.",
			"official"
	];
	data[i++] = [
			"Spectacular Success",
